  ...
  <div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
      ...
      <div class="p-5 mt-6 intro-y box">
        ...
        >
          <a href="#top" class="flex items-center px-3 py-2 rounded-md">
          ...
          >
            ...
            >
              ...
              {#if faker.files[0].type == "Empty Folder"}
                <FileIcon class="w-3/5 mx-auto" variant="empty-directory" />
              {:else if faker.files[0].type == "Folder"}
                <FileIcon class="w-3/5 mx-auto" variant="directory" />
