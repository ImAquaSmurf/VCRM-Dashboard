...
<div>
  ...
  <div class="grid grid-cols-12 gap-6 mt-5 intro-y">
    ...
    {#each _.take(fakerData, 9) as faker, fakerKey}
      <div class="col-span-12 intro-y md:col-span-6 xl:col-span-4 box">
        <div
        ...
        >
          ...
          <div class="ml-3 mr-auto">
            ...
            <div class="flex text-slate-500 truncate text-xs mt-0.5">
              <a class="inline-block truncate text-primary" href="#top">
          ...
          <Menu class="ml-3">
            <Menu.Button as="a" class="w-5 h-5 text-slate-500">
        ...
        <div class="p-5">
          ...
          <a href="#top" class="block mt-5 text-base font-medium">
            {faker.news[0].title}
          </a>
