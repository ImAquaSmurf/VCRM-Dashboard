<script lang="ts">
  ...
  let importantNotesRef: TinySliderElement;

  const prevImportantNotes = () => {
    importantNotesRef?.tns.goTo("prev");
  };
  const nextImportantNotes = () => {
    importantNotesRef?.tns.goTo("next");
  };
</script>
    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="col-span-12 mt-6 -mb-6 intro-y">
        ...
        >
          ...
          <Alert.DismissButton class="text-white" on:click={dismiss}>
      ...
      <div class="col-span-12 mt-2 lg:col-span-8 xl:col-span-6">
        ...
        <div
          class="relative mt-12 intro-y sm:mt-5 before:content-[''] before:w-[90%] before:shadow-[0px_3px_5px_#0000000b] before:bg-white/60 before:h-full before:mt-2.5 before:absolute before:rounded-md before:mx-auto before:inset-x-0 before:dark:bg-darkmode-400/70"
        >
          <div class="box sm:flex">
            <div class="flex flex-col justify-center flex-1 px-8 py-12">
              ...
              <div class="mt-4 text-slate-500">
                Sales earnings this month after associated author fees, & before
                taxes.
              </div>
              <Button
            ...
            >
              ...
              <div class="mt-5 text-xs text-slate-500">GROSS RENTAL VALUE</div>
              <div class="mt-1.5 flex items-center">
              ...
              <div class="mt-5 text-xs text-slate-500">GROSS RENTAL PROFIT</div>
              <div class="mt-1.5 flex items-center">
      ...
      <div class="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3">
        <div class="flex items-center h-10 intro-y">
          ...
          <a href="#top" class="ml-auto truncate text-primary"> View on Map </a>
        </div>
        <div
          class="mt-5 intro-y relative before:content-[''] before:w-[90%] before:shadow-[0px_3px_5px_#0000000b] before:bg-white/60 before:h-full before:mt-2.5 before:absolute before:rounded-md before:mx-auto before:inset-x-0 before:dark:bg-darkmode-400/70"
        >
          <div class="p-5 box">
      ...
      >
        <div class="flex items-center h-10 intro-y">
          ...
          <a href="#top" class="ml-auto truncate text-primary"> Show More </a>
        </div>
        <div
          class="mt-5 intro-y relative before:content-[''] before:w-[90%] before:shadow-[0px_3px_5px_#0000000b] before:bg-white/60 before:h-full before:mt-2.5 before:absolute before:rounded-md before:mx-auto before:inset-x-0 before:dark:bg-darkmode-400/70"
        >
            ...
            <Tab.Panels class="mt-6">
              <Tab.Panel>
                ...
                <div class="mx-auto mt-5 w-52 sm:w-auto">
                  <div class="flex items-center">
                    <div class="w-2 h-2 mr-3 rounded-full bg-primary" />
                    <span class="truncate">17 - 30 Years old</span>
                    <span class="ml-auto font-medium">62%</span>
                  </div>
                  <div class="flex items-center mt-4">
                    <div class="w-2 h-2 mr-3 rounded-full bg-pending" />
                    <span class="truncate">31 - 50 Years old</span>
                    <span class="ml-auto font-medium">33%</span>
                  </div>
                  <div class="flex items-center mt-4">
                    <div class="w-2 h-2 mr-3 rounded-full bg-warning" />
      ...
      <div class="col-span-12 mt-6 lg:col-span-6">
        <div class="relative p-8 overflow-hidden box intro-y">
          ...
          <div class="w-full mt-2 leading-relaxed sm:w-64 text-slate-500">
                ...
                <Table.Tr key={fakerKey} class="intro-x">
                  ...
                  >
                    <div class="flex items-center justify-center">
                      ...
                      <a class="flex items-center text-danger" href="#top">
        ...
        <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-12 2xl:mt-8">
          ...
          <div class="mt-5 intro-x">
            <div class="box zoom-in">
              <TinySlider bind:ref={importantNotesRef}>
                <div class="p-5">
