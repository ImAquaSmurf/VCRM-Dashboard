    ...
    <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
      <div class="p-5 rounded-md box">
        ...
        <div class="flex items-center">
          ...
          Invoice:
          <a href="#top" class="ml-1 underline decoration-dotted">
          ...
          <Table striped>
            <Table.Thead>
              <Table.Tr>
                ...
                <Table.Th class="text-right whitespace-nowrap">Total</Table.Th>
              </Table.Tr>
            </Table.Thead>
            <Table.Tbody>
              {#each _.take(fakerData, 8) as faker, fakerKey}
                <Table.Tr key={fakerKey}>
                  <Table.Td class="!py-4">
                    <div class="flex items-center">
                      ...
                      <a href="#top" class="ml-4 font-medium whitespace-nowrap">
