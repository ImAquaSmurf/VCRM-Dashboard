    ...
    <div class="flex items-center mt-8 intro-y">
      ...
      <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 intro-y lg:col-span-6">
          ...
          <!-- END: Heading -->
          <!-- BEGIN: Text Settings -->
          <Preview let:toggle class="mt-5 intro-y box">
                <div class="flex flex-col items-center p-5 border-b sm:flex-row border-slate-200/60 dark:border-darkmode-400">
        ...
        <div class="col-span-12 intro-y lg:col-span-6">
          ...
          <Preview let:toggle class="intro-y box">
                ...
                <div class="p-5">
                  <Preview.Panel>
                    ...
                    <div class="mt-2">
                      <span class="px-1 mr-1 text-xs text-white rounded-full bg-primary">
                        1
                      </span>
                      <span class="px-1 mr-1 text-xs border rounded-full text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300">
                        2
                      </span>
                      <span class="px-1 mr-1 text-xs text-white rounded-full bg-success">
                        3
                      </span>
                      <span class="px-1 mr-1 text-xs text-white rounded-full bg-warning">
                        4
                      </span>
                      <span class="px-1 mr-1 text-xs text-white rounded-full bg-danger">
                        5
                      </span>
                      <span class="px-1 mr-1 text-xs rounded-full bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300">
                        6
                      </span>
                    </div>
                    ...
                    <div class="mt-3">
                      ...
                      <span class="px-2 py-1 mr-1 border rounded-full text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300">
                        2
                      </span>
                      ...
                      <span class="px-2 py-1 mr-1 rounded-full bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300">
                        6
                      </span>
                    </div>
                    <div class="mt-4">
                      ...
                      <span class="px-3 py-2 mr-1 border rounded-full text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300">
                        2
                      </span>
                      ...
                      <span class="px-3 py-2 mr-1 rounded-full bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300">
                        6
                      </span>
                    </div>
                    <div class="mt-6">
                      ...
                      <span class="px-4 py-3 mr-1 border rounded-full text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300">
                        2
                      </span>
                      ...
                      <span class="px-4 py-3 mr-1 rounded-full bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300">
                        6
                      </span>
                    </div>
                    ...
                    <div class="mt-2">
                      ...
                      <span class="px-1 mr-1 text-xs border text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300">
                        2
                      </span>
                      ...
                      <span class="px-1 mr-1 text-xs bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300">
                        6
                      </span>
                    </div>
                    <div class="mt-6 font-medium">Outline Badge</div>
                    <div class="mt-4">
                      <span class="px-3 py-2 mr-1 border rounded-full border-primary text-primary dark:border-primary">
                        1
                      </span>
                      <span class="px-3 py-2 mr-1 border rounded-full text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300">
                        2
                      </span>
                      <span class="px-3 py-2 mr-1 border rounded-full border-success text-success dark:border-success">
                        3
                      </span>
                      <span class="px-3 py-2 mr-1 border rounded-full border-warning text-warning dark:border-warning">
                        4
                      </span>
                      <span class="px-3 py-2 mr-1 border rounded-full border-danger text-danger dark:border-danger">
                        5
                      </span>
                    </div>
                  </Preview.Panel>
          ...
          <Preview let:toggle class="mt-5 intro-y box">
                ...
                <div class="p-5">
                  <Preview.Panel>
                    <div class="flex justify-center w-full mt-2 border-t border-slate-200/60 dark:border-darkmode-400">
          ...
          <Preview let:toggle class="mt-5 intro-y box">
                ...
                <div class="p-5">
                  <Preview.Panel>
                    <div>
                      <a href="#top" class="block font-normal text-primary">
                        Example text
                      </a>
                      <a href="#top" class="block font-medium text-primary">
                        Example medium text
                      </a>
                      <a href="#top" class="block font-semibold text-primary">
                        Example semibold text
                      </a>
                      <a href="#top" class="block font-bold text-primary">
                        Example bolder text
                      </a>
                      <a href="#top" class="block font-extrabold text-primary">
                        Example boldest text
                      </a>
                    </div>
                    <div class="mt-5">
                      <a href="#top" class="block text-primary">
                        Primary state
                      </a>
                      <a
                        href="#top"
                      ...
                      <a href="#top" class="block text-success">
                        Success state
                      </a>
                      <a href="#top" class="block text-warning">
                        Warning state
                      </a>
                      <a href="#top" class="block text-danger">
                        Danger state
                      </a>
                    </div>
                  </Preview.Panel>
              ...
              <div class="mt-5">
                <a href="#top" class="block text-primary">Primary state</a>
                <a href="#top" class="block text-slate-600 dark:text-slate-500"
                  >Secondary state</a
                >
                <a href="#top" class="block text-success">Success state</a>
                <a href="#top" class="block text-warning">Warning state</a>
                <a href="#top" class="block text-danger">Danger state</a>
              </div>
              `}
                    </Preview.Highlight>
                  </Preview.Panel>
