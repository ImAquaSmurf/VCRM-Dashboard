<script lang="ts">
  ...
  let className: FileIconProps["className"] = undefined;
  let variant: FileIconProps["variant"];
  let type: FileIconProps["type"] = undefined;
  let src: FileIconProps["src"] = undefined;

  export { className as class, variant, type, src };
</script>
