          ...
          <div class="pr-1">
            <div class="px-5 pt-5 pb-5 mt-5 box lg:pb-0">
              ...
              <div class="overflow-x-auto scrollbar-hidden">
                <div class="flex mt-5">
                  {#each _.take(fakerData, 10) as faker, fakerKey}
                    <a href="#top" class="w-10 mr-4 cursor-pointer">
        ...
        {#if chatBox}
          <div class="flex flex-col h-full">
            ...
            >
              ...
              >
                <a href="#top" class="w-5 h-5 text-slate-500">
                  <Lucide icon="Search" class="w-5 h-5" />
                </a>
                <a href="#top" class="w-5 h-5 ml-5 text-slate-500">
