      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        >
          <div
            class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400"
          >
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Product Information
          </div>
          <div class="mt-5">
            <FormInline
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <TomSelect
                  ...
                  multiple
                >
                  {#each _.take(fakerData, 2) as faker, fakerKey}
          ...
          <div class="mt-5">
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <div class="flex flex-col sm:flex-row">
                  <FormCheck class="mr-4">
                    ...
                    />
                    <FormCheck.Label for="condition-new">New</FormCheck.Label>
                  </FormCheck>
                  <FormCheck class="mt-2 mr-4 sm:mt-0">
                    ...
                    />
                    <FormCheck.Label for="condition-second">
                      Second
                    </FormCheck.Label>
                  </FormCheck>
                </div>
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                ...
                <FormHelp class="text-right">Maximum character 0/2000</FormHelp>
              </div>
            </FormInline>
            <FormInline
              class="flex-col items-start pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0"
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        >
          <div
            class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400"
          >
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Product Variant (Details)
          </div>
          <div class="mt-5">
            <FormInline
                ...
                >
                  ...
                  <div>
                      ...
                      <div class="flex-1">
                        <div class="items-center mt-5 xl:flex first:mt-0">
                          ...
                          <div class="flex w-20 mt-3 text-slate-500 xl:mt-0">
                            <a href="#top" class="xl:ml-5">
                              <Lucide icon="Move" class="w-4 h-4" />
                            </a>
                            <a href="#top" class="ml-3 xl:ml-5">
                    ...
                    <div class="mt-5 xl:ml-20 xl:pl-5 xl:pr-20 first:mt-0">
                      ...
                      >
                        <Lucide icon="Plus" class="w-4 h-4 mr-2" /> Add New Option
                      </Button>
                    </div>
                  </div>
                </div>
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <div class="overflow-x-auto">
                  <Table class="border">
                    ...
                    <Table.Tbody>
                      <Table.Tr>
                        <Table.Td rowSpan={3} class="border-r">Small</Table.Td>
                      ...
                      <Table.Tr>
                        <Table.Td rowSpan={3} class="border-r">Medium</Table.Td>
                        <Table.Td>Black</Table.Td>
                        <Table.Td class="!px-2">
                          <InputGroup>
                            <InputGroup.Text>$</InputGroup.Text>
                      ...
                      <Table.Tr>
                        <Table.Td rowSpan={3} class="border-r">Large</Table.Td>
                        <Table.Td>Black</Table.Td>
                        <Table.Td class="!px-2">
                          <InputGroup>
                            <InputGroup.Text>$</InputGroup.Text>
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                  ...
                  <Table class="border">
                    <Table.Thead>
                      <Table.Tr>
                        ...
                        />
                        <Table.Th class="bg-slate-50 dark:bg-darkmode-800" />
                        <Table.Th
                ...
                >
                  <Lucide icon="Plus" class="w-4 h-4 mr-2" /> Add New Wholesale Price
                </Button>
              </div>
            </FormInline>
          </div>
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        >
          <div
            class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400"
          >
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Product Management
          </div>
          <div class="mt-5">
            <FormInline
              class="flex-col items-start pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0"
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormSwitch>
                  <FormSwitch.Input
                    ...
                    type="checkbox"
                  />
                  <FormSwitch.Label for="product-status-active">
                    Active
                  </FormSwitch.Label>
                </FormSwitch>
              </div>
                ...
                >
                  <div class="flex items-center">
                    ...
                    <span class="text-slate-800 dark:text-slate-500">
                      ...
                      <a class="font-medium text-primary" href="#top">
                        Learn More
                      </a>
                    </span>
                    <Alert.DismissButton
                ...
                <div class="flex flex-col sm:flex-row">
                  <FormCheck class="mr-4">
                    <FormCheck.Input
                      ...
                      value="horizontal-radio-chris-evans"
                    />
                    <FormCheck.Label for="shipping-service-standard">
                      Standard
                    </FormCheck.Label>
                  </FormCheck>
                  <FormCheck class="mt-2 mr-4 sm:mt-0">
                    <FormCheck.Input
                      ...
                      value="horizontal-radio-liam-neeson"
                    />
                    <FormCheck.Label for="shipping-service-custom">
                      Custom
                    </FormCheck.Label>
                  </FormCheck>
                </div>
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <a href="#top">Upload Product</a>
          </li>
          <li
            class="pl-5 mb-4 border-l-2 border-transparent dark:border-transparent"
          >
            <a href="#top">Product Information</a>
          </li>
          <li
            class="pl-5 mb-4 border-l-2 border-transparent dark:border-transparent"
          >
            <a href="#top">Product Detail</a>
          </li>
          <li
            class="pl-5 mb-4 border-l-2 border-transparent dark:border-transparent"
          >
            <a href="#top">Product Variant</a>
          </li>
          <li
            class="pl-5 mb-4 border-l-2 border-transparent dark:border-transparent"
          >
            <a href="#top">Product Variant (Details)</a>
          </li>
          <li
            class="pl-5 mb-4 border-l-2 border-transparent dark:border-transparent"
          >
            <a href="#top">Product Management</a>
          </li>
          <li
            class="pl-5 mb-4 border-l-2 border-transparent dark:border-transparent"
          >
            <a href="#top">Weight & Shipping</a>
          </li>
        </ul>
        <div
