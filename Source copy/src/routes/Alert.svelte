      ...
      <div class="grid grid-cols-12 gap-6 mt-5 intro-y">
                  ...
                  <Preview.Panel>
                    ...
                    <Alert variant="secondary" class="mb-2">
                      <div class="flex items-center">
                        ...
                        <div class="px-1 ml-auto text-xs text-white rounded-md bg-slate-500">
                          New
                        </div>
                      </div>
                      <div class="mt-3">
        ...
        <div class="col-span-12 lg:col-span-6">
          ...
          <Preview let:toggle class="intro-y box">
                ...
                <div class="p-5">
                  <Preview.Panel>
                    <Alert variant="primary" class="flex items-center mb-2" let:dismiss>
                          <Lucide icon="AlertCircle" class="w-6 h-6 mr-2" />
                          Awesome alert with icon
                          <Alert.DismissButton
                            type="button"
                    ...
                    <Alert variant="success" class="flex items-center mb-2" let:dismiss>
                          <Lucide
                            icon="AlertTriangle"
                            class="w-6 h-6 mr-2"
                          />
                    ...
                    <Alert variant="warning" class="flex items-center mb-2" let:dismiss>
                          <Lucide icon="AlertCircle" class="w-6 h-6 mr-2" />
                          Awesome alert with icon
                          <Alert.DismissButton
                            type="button"
                    ...
                    <Alert variant="pending" class="flex items-center mb-2" let:dismiss>
                          <Lucide
                            icon="AlertTriangle"
                            class="w-6 h-6 mr-2"
                          />
                    ...
                    <Alert variant="danger" class="flex items-center mb-2" let:dismiss>
                          <Lucide
                            icon="AlertOctagon"
                            class="w-6 h-6 mr-2"
                          />
                    ...
                    <Alert variant="dark" class="flex items-center mb-2" let:dismiss>
                          <Lucide
                            icon="AlertTriangle"
                            class="w-6 h-6 mr-2"
                          />
